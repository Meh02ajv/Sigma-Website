...
<head>
    ...
    <!-- SEO Meta Tags -->
    <meta name="description" content="Yearbook SIGMA - Annuaire public des anciens élèves. Recherchez et retrouvez vos anciens camarades par promotion et nom. Accessible à tous sans connexion.">
    <meta name="keywords" content="yearbook sigma, annuaire anciens élèves, trombinoscope, recherche alumni, promotions sigma, anciens camarades">
    <meta name="author" content="SIGMA Alumni">
    <meta name="robots" content="index, follow">
    
    <!-- Page Title -->
    <title>Yearbook SIGMA - Annuaire Public des Anciens Élèves | SIGMA Alumni</title>
    
    <!-- Canonical URL -->
    <link rel="canonical" href="<?php echo 'https://' . $_SERVER['HTTP_HOST'] . '/yearbook_public.php'; ?>">
    
    <!-- Open Graph Meta Tags (Facebook, LinkedIn) -->
    <meta property="og:title" content="Yearbook SIGMA - Annuaire Public des Anciens Élèves">
    <meta property="og:description" content="Recherchez et retrouvez vos anciens camarades de SIGMA. Annuaire public accessible à tous.">
    <meta property="og:type" content="website">
    <meta property="og:url" content="<?php echo 'https://' . $_SERVER['HTTP_HOST']; ?>/yearbook_public.php">
    ...
    <meta name="twitter:title" content="Yearbook SIGMA - Annuaire Public">
    <meta name="twitter:description" content="Recherchez et retrouvez vos anciens camarades de SIGMA dans notre annuaire public.">
    ...
    <script type="application/ld+json">
    {
      ...
      "@type": "ItemList",
      "name": "Yearbook SIGMA - Annuaire des Anciens Élèves",
      "description": "Liste des anciens élèves de SIGMA",
      "url": "<?php echo 'https://' . $_SERVER['HTTP_HOST']; ?>/yearbook_public.php",
      "numberOfItems": <?php echo $total_users; ?>
    }
    </script>
