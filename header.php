...
<head>
    ...
    <!-- SEO Meta Tags -->
    <meta name="description" content="SIGMA Alumni - Réseau professionnel des anciens élèves de SIGMA. Retrouvez vos camarades, participez aux événements, votez aux élections et partagez vos souvenirs au sein de notre communauté d'anciens.">
    <meta name="keywords" content="SIGMA Alumni, anciens élèves, réseau professionnel, yearbook, annuaire, communauté étudiante, événements alumni, élections bureau, messagerie, networking">
    ...
    <!-- Page Title -->
    <title>SIGMA Alumni - <?php echo ucfirst(str_replace('.php', '', $current_page)); ?> | Réseau des Anciens Élèves</title>
    
    <!-- Canonical URL -->
    <link rel="canonical" href="<?php echo 'https://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; ?>">
    
    <!-- Open Graph Meta Tags (Facebook, LinkedIn) -->
    <meta property="og:title" content="SIGMA Alumni - Réseau des Anciens Élèves">
    <meta property="og:description" content="Rejoignez la communauté SIGMA Alumni. Réseau professionnel, événements, messagerie et bien plus pour rester connecté avec vos anciens camarades.">
    <meta property="og:type" content="website">
    <meta property="og:url" content="<?php echo 'https://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; ?>">
    <meta property="og:image" content="<?php echo 'https://' . $_SERVER['HTTP_HOST']; ?>/img/image.png">
    <meta property="og:image:width" content="1200">
    <meta property="og:image:height" content="630">
    <meta property="og:site_name" content="SIGMA Alumni">
    <meta property="og:locale" content="fr_FR">
    
    <!-- Twitter Card Meta Tags -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="SIGMA Alumni - Réseau des Anciens Élèves">
    <meta name="twitter:description" content="Rejoignez la communauté SIGMA Alumni. Réseau professionnel, événements, messagerie et bien plus.">
    <meta name="twitter:image" content="<?php echo 'https://' . $_SERVER['HTTP_HOST']; ?>/img/image.png">
    
    <!-- LinkedIn Specific -->
    <meta property="article:author" content="SIGMA Alumni">
    
    <!-- Contact & Social Media -->
    <meta name="contact" content="contact@sigma-alumni.org">
    ...
    <script type="application/ld+json">
    {
      ...
      "@type": "Organization",
      "name": "SIGMA Alumni",
      "description": "Réseau professionnel des anciens élèves de SIGMA",
      "url": "<?php echo 'https://' . $_SERVER['HTTP_HOST']; ?>",
      "logo": "<?php echo 'https://' . $_SERVER['HTTP_HOST']; ?>/img/image.png",
      "contactPoint": {
        "@type": "ContactPoint",
      ...
      "sameAs": [
        "<?php echo $configs['linkedin_url'] ?? 'https://linkedin.com/company/sigma-alumni'; ?>",
        "<?php echo $configs['instagram_url'] ?? 'https://instagram.com/sigmaofficial'; ?>"
      ]
    }
    </script>
    ...
    <style>
        ...
        * {
        ...
        /* Tablet breakpoint: avoid header overflow on iPad/Surface widths */
