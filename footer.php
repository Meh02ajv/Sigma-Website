...
$current_year = date('Y');
$is_user_logged_in_footer = isset($_SESSION['user_id']);

// Liens adaptes selon l'etat de connexion
$footer_home_link = $is_user_logged_in_footer ? 'dashboard.php' : 'accueil.php';
$footer_annuaire_link = $is_user_logged_in_footer ? 'yearbook.php' : 'connexion.php?redirect=annuaire';
?>
    ...
    <div class="footer-container">
        <div class="footer-grid">
            ...
            <div class="footer-col">
                <h4>Navigation</h4>
                <ul>
                    <li><a href="<?php echo $footer_home_link; ?>"><i class="fas fa-home"></i> Accueil</a></li>
                    ...
                    <?php if (!$is_user_logged_in_footer): ?>
            ...
            <div class="footer-col">
                ...
                <ul>
                    ...
                    <li><a href="<?php echo $footer_annuaire_link; ?>"><i class="fas fa-address-book"></i> Annuaire</a></li>
...
<style>
    ...
    @media (max-width: 600px) {
        ...
        /* Sur telephone, masquer Navigation et Ressources */
    ...
    @media (max-width: 400px) {
        .footer-container {
            padding: 1.75rem 3.5% 0.9rem 5.5%;
        }
